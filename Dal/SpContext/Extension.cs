...
namespace Dal
{
  public static class Extension
  {
    ...
    public static IEnumerable<T> Parse<T>(this SqlDataReader reader, ICollectionMapper mappers) where T : new()
    {
    ...
    public async static Task<IEnumerable<T>> ParseAsync<T>(this SqlDataReader reader, ICollectionMapper mappers) where T : new()
    {
      var ret = new HashSet<T>();
      var map = mappers.Get<T>();
