...
namespace Saas.Services
{
  ...
  internal class RestaurantService : RestaurantSvc.RestaurantSvcBase
  {
    ...
    {
      using var sp = _dbContext.ReadContext<Restaurant>(_refData.AppSetting.Id, context.GetHttpContext().User, OperationType.R);
    ...
    {
      using var sp = _dbContext.WriteContext<Restaurant>(_refData.AppSetting.Id, context.GetHttpContext().User, OperationType.C);
    ...
    {
      using var sp = _dbContext.WriteContext<Restaurant>(_refData.AppSetting.Id, context.GetHttpContext().User, OperationType.U);
    ...
    {
      using var sp = _dbContext.WriteContext<Restaurant>(_refData.AppSetting.Id, context.GetHttpContext().User, OperationType.D);
