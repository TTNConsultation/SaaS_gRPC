...
namespace Saas.Services
{
  ...
  internal class RestaurantService : RestaurantSvc.RestaurantSvcBase
  {
    ...
    {
      using var sp = DbContext.ReadWrite<Restaurant>(RefData.App.Id, context.GetHttpContext().User, OperationType.C);
    ...
    {
      using var sp = DbContext.ReadWrite<Restaurant>(RefData.App.Id, context.GetHttpContext().User, OperationType.U);
    ...
    {
      using var sp = DbContext.ReadWrite<Restaurant>(RefData.App.Id, context.GetHttpContext().User, OperationType.D);
