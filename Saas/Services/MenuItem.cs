...
namespace Saas.Services
{
  internal class MenuItemService : MenuItemSvc.MenuItemSvcBase
  {
    ...
    {
      using var sp = _dbContext.ReadContext<MenuItem>(_refData.AppSetting.Id, context.GetHttpContext().User, OperationType.R);
    ...
    {
      using var sp = _dbContext.WriteContext<MenuItem>(_refData.AppSetting.Id, context.GetHttpContext().User, OperationType.C);
