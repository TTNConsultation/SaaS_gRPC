...
{
	public partial class zAAFConn_BaseData : IDisposable
	{
		#region members
		protected zAAFConn_TxConnectionProvider _connectionProvider;
		static string _staticConnectionString;
		bool _isDisposed = false;
		#endregion

		#region initialisation
		public zAAFConn_BaseData()
		{
			Init();
		}
		...
		public virtual zAAFConn_TxConnectionProvider ConnectionProvider
		{
			set
			{
				if(value == null)
		...
		public static string StaticConnectionString
		{
			...
			get
			{
				...
				return zAAFConn_ConfigWrapper.GetConnectionString("cfdc4ae0-9302-4245-a352-9276d4a94515");
			}
		}
		#endregion
